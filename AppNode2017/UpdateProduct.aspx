<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="AppNode2017.UpdateProduct" %>
      ...
      <br />
        <div class="container center">          
          <div class="jumbotron center">
              <h2>Editar producto de la base de datos </h2>
          </div>          
      </div>
                  ...
                  <form role="form" runat="server">
                      <div class="col-lg-4">
                          ...
                          <div class="form-group">
                              ...
                              <br />
                              <asp:Button ID="btsearch" runat="server" Text="Buscar" CssClass="btn btn-warning" OnClick="btSearch_Click" />
                              <br />
                          </div>
                           <div class="form-group">
                              <label>Nombre</label>
                          ...
                          <div class="form-group">                              
                              ...
                              <asp:Button ID="btUbdate" runat="server" Text="Guardar cambios" CssClass="btn btn-warning" OnClick="udpate_Click" />
